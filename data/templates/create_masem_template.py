...
STUDY_METADATA_COLS = [
    ...
    ("search_source", 18, "list", "WoS,Scopus,PsycINFO,IEEE,ACM,GoogleScholar,citation_tracking", "Database where study was found", "Scopus"),
    ...
    ("industry_sector", 18, "list", "healthcare,education,IT,manufacturing,finance,government,general", "Industry sector of sample", "healthcare"),
    ("ai_type", 20, "list", "generative,predictive,decision_support,conversational,general", "Type of AI technology studied", "generative"),
    ...
    ("sample_type", 15, "list", "employees,students,managers,consumers,mixed", "Type of respondents", "employees"),
    ("job_level", 15, "list", "frontline,middle_mgmt,senior_mgmt,mixed,NA", "Job level of respondents", "frontline"),
...
MODERATOR_VARIABLES_COLS = [
    ("study_id", 10, "integer", "FK to STUDY_METADATA", "Must match a study_id in STUDY_METADATA", "1"),
    ("ai_type", 20, "list", "generative,predictive,decision_support,conversational", "Type of AI technology", "generative"),
    ("industry", 18, "list", "healthcare,education,IT,manufacturing,finance,government,general", "Industry sector", "education"),
    ...
    ("sample_context", 18, "list", "workplace,education,general", "Context of the sample", "workplace"),
...
SEARCH_LOG_COLS = [
    ("database", 18, "list", "WoS,Scopus,PsycINFO,IEEE,ACM,GoogleScholar", "Database searched", "Scopus"),
...
def main():
    ...
    # Save
    output_path = "/Users/hosung/dissertation_AI-adoption_meta/data/templates/AI_Adoption_MASEM_Coding_v1.xlsx"
    wb.save(output_path)
