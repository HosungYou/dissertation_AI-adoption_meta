...
**Included AI Technologies:**
- Machine learning systems (supervised, unsupervised, reinforcement learning)
- Deep learning and neural networks
- Natural language processing (NLP) systems
- Generative AI (ChatGPT, DALL-E, Midjourney, etc.)
- Large language models (LLMs)
- Computer vision and image recognition
- Speech recognition and synthesis
- Recommender systems (when AI-based)
- Autonomous agents and robots
- Decision support systems (when AI/ML-based)
- Intelligent tutoring systems
- AI-powered analytics and prediction tools
...
- "Information systems" without AI component: EXCLUDED

**Boundary Cases:**
- Expert systems (legacy AI): INCLUDED if post-2015
- Rule-based automation without learning: EXCLUDED
- Business intelligence dashboards without ML: EXCLUDED
- AI-augmented tools (e.g., Excel with AI features): INCLUDED if AI is focal
...
**Population:**
- Any human population (students, workers, general public, patients, etc.)
...
3. **Non-AI Technology Focus**
   ...
   - Social media, mobile apps, e-commerce (unless AI-powered)
...
### Case 9: Multi-Group Study (e.g., Country Comparison)

**Scenario:** Study reports separate correlation matrices for USA (n=300) and China (n=280).

**Decision:** Treat as TWO independent studies for meta-analysis.

**Coding:**
- study_id: AuthorYear_USA, AuthorYear_China
- Moderator: code country for each

**Rationale:** Independent samples, potentially different construct meanings (cultural differences). Pooling would mask heterogeneity.
...
6. **Student Sample:** Convenience sample of university students
