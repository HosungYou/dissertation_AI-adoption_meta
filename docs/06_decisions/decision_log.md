...
This document tracks all major methodological and analytical decisions made throughout the AI adoption meta-analysis dissertation, including rationale and alternatives considered.
...
| 2026-02-16 | **Sabherwal et al. (2006) as Bayesian priors** | Directly quantifies AI vs. IT adoption differences; Sabherwal is gold-standard IT meta-analysis (612 findings, N>50k); enables statistical test of "AI ≠ IT" | **Diffuse priors:** Less informative, loses opportunity for IT comparison. **Other IT meta-analyses:** Sabherwal most comprehensive and includes UTAUT paths | Unique contribution: first study to statistically compare AI to IT adoption using Bayesian framework |
...
| 2026-02-17 | **Subgroup analysis for generative vs. predictive AI** | Theoretically meaningful: generative AI (black-box, creative) vs. predictive AI (decision-support) differ in trust/transparency needs | **No AI type moderator:** Misses important heterogeneity source. **More granular categories:** Too sparse (conversational, computer vision, etc.) | Tests key theoretical hypothesis: trust matters more for generative AI (TRU→BI stronger in generative subgroup) |
...
**Moderators:**
- AI type: Generative (opaque, creative) vs. predictive (transparent, decision-support) theoretically differ in trust/transparency needs
- Era (pre/post ChatGPT): Captures normalization and mainstreaming of AI
- Culture: Social influence stronger in collectivist cultures (established finding in IT adoption)
...
**Bayesian Extension:**
- Unique contribution: Statistically compares AI to IT adoption
- Uses best available IT priors (Sabherwal et al., 2006)
- Bayes Factors quantify evidence for "AI ≠ IT"
...
- Not feasible for dissertation timeline

**When this would be appropriate:**
- If raw data available from all/most studies
- If testing complex multilevel models
- If sufficient resources and time (beyond dissertation scope)
...
- Perceived job threat (too few studies, k<10)
- Ethical concerns (measurement too heterogeneous)
- Perceived intelligence (confounded with performance expectancy)
- Cost/price (UTAUT2 construct, rarely in AI studies)

**Future work:** As literature matures, expand to 16-20 constructs
...
1. **Early construct harmonization:** Defining 12 constructs upfront streamlined coding
2. **AI-assisted coding:** Massive time savings, high accuracy with 3-model consensus
3. **Hybrid TSSEM/OSMASEM:** Leveraged strengths of both approaches
4. **Bayesian extension:** Unique contribution, directly compares AI to IT
5. **Network triangulation:** Strengthened findings through convergent evidence

### What Would We Do Differently

1. **Pilot harmonization earlier:** Could have refined construct definitions based on pilot coding
2. **More granular AI types:** Generative/predictive is coarse; could split generative into text/image/code
3. **Pre-register protocol:** Would strengthen reproducibility (considered but not required for dissertation)
4. **Earlier committee input:** Could have adjusted models based on earlier feedback

### Advice for Future Researchers

1. **Start with clear construct definitions:** Harmonization is critical and time-consuming
...
5. **Document decisions:** This log is invaluable for writing and defending methods
