...
**Study:** Johnson et al. (2024). "AI Chatbot Adoption in Healthcare." *Journal of Medical Informatics*, 45(3), 210-225.
...
- Map to standard constructs:
  - PU → PE (Perceived Usefulness)
  - PEOU → EE (Perceived Ease of Use)
  - SN → SI (Subjective Norm)
  - ATT → ATT (Attitude)
  - INT → BI (Intention)
  - Trust → TRU (AI Trust)
...
- Add to `studies.csv`: Johnson2024, n=285, ai_type=Conversational, industry=Healthcare

### Step 6: Document
- Notes: "Correlation matrix in Table 4, page 218. All constructs harmonized to standard 12."
