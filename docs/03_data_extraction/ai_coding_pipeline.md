...
This document describes the 7-phase AI-assisted coding pipeline for extracting correlation matrices and study metadata from included studies. The pipeline combines automated AI extraction with human validation to achieve high accuracy while reducing manual coding burden.
...
- Input: All included study PDFs (k=100-250 studies)
...
### Output
- ChromaDB index with ~1,500-3,000 chunks (15-20 chunks per study × 100-150 studies)
...
```markdown
You are extracting correlation data for meta-analysis on AI adoption.
...
### Estimated Cost
- ~$0.50-1.00 per study × 150 studies = **$75-150 total**
...
4. FC (Facilitating Conditions) - Resources, organizational support
...
- 20% of total studies (e.g., 30 studies if k=150)
- Stratify by:
  - Publication year (2015-2019, 2020-2022, 2023-2025)
  - AI type (generative, predictive, other)
...
4. **Expert adjudication** (if still unclear, escalate to dissertation chair)
...
### Total Project Costs (k=150 studies)

| Component | Cost |
|-----------|------|
| AI extraction (all 3 models × 150 studies) | $200 |
| RAG infrastructure (ChromaDB hosting, embeddings) | $20 |
| Human coding (20% ICR sample) | $0 (dissertation labor) |
| **Total AI pipeline cost** | **~$220** |

### Cost-Benefit Analysis

**Traditional Manual Coding:**
- 150 studies × 2 coders × 45 min/study = 225 hours
- At $30/hour RA rate: $6,750

**AI-Assisted Pipeline:**
- AI costs: $220
- Human verification (20% ICR + discrepancy resolution): ~40 hours
- At $30/hour: $1,200
- **Total: $1,420**

**Savings: $5,330 (79% reduction)**
