...
This document compares Two-Stage Structural Equation Modeling (TSSEM) and One-Stage Meta-Analytic Structural Equation Modeling (OSMASEM), providing guidance on when to use each approach in the AI adoption meta-analysis.
...
- Generative AI vs. Predictive AI (subgroup TSSEM)
- Healthcare vs. Education vs. Business (subgroup TSSEM)
...
- k < 30 studies total
- Or unbalanced subgroups (e.g., k=80 generative, k=20 predictive)

✅ **Transparency and reproducibility priorities**
- Dissertation committee may prefer clear two-stage logic
- Easier to explain to non-statistical audiences
...
- Hofstede individualism score (0-100)
- Sample mean age as moderator

✅ **Moderator interactions**
- Does year effect differ by AI type?
- Does culture moderate the PE→BI path differently than the TRU→BI path?
...
- Subgroup TSSEM:
  ...
  - Healthcare vs. Education vs. Business vs. General
...
- Hofstede individualism (continuous: 0-100)
